...
/**
 * CAPTCHA, полностью на клиенте: код генерируется в браузере и рисуется на canvas.
 * С бэкендом не связана.
 */
@Component({
...
export class Captcha {
  ...
  /** Срабатывает, когда картинка обновилась (кнопкой или после отправки формы) */
  ...
  /** Проверка введённого текста, регистр не важен */
  ...
  private draw(text: string): void {
    ...
    // Символы: случайный размер, наклон и смещение
